...
ActiveRecord::Schema[7.0].define(version: 2023_01_03_105842) do
  ...
  create_table "employees", force: :cascade do |t|
    ...
    t.integer "master_employee_role_id", null: false
    ...
    t.index ["master_employee_role_id"], name: "index_employees_on_master_employee_role_id"
    t.index ["reset_password_token"], name: "index_employees_on_reset_password_token", unique: true
    t.index ["unlock_token"], name: "index_employees_on_unlock_token", unique: true
  end

  create_table "master_employee_roles", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "projectors", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["employee_id"], name: "index_projectors_on_employee_id"
    t.index ["project_id"], name: "index_projectors_on_project_id"
  end
  ...
  add_foreign_key "employees", "master_employee_roles"
  add_foreign_key "projectors", "employees"
  add_foreign_key "projectors", "projects"
end
